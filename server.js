...
app.post('/api/send-email', async (req, res) => {
  try {
    ...
    const customerMailOptions = {
      from: `"Sun Point Appliances" <${process.env.VITE_FROM_EMAIL}>`,
      to: email,
      subject: 'Thank You for Your Inquiry - Sun Point Appliances (AKBARALLYS)',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Thank You - Sun Point Appliances</title>
            <style>
                body {
                    margin: 0;
                    padding: 0;
        ...
        <body>
            <div class="email-container">
                <div class="email-header">
                    ...
                    <p>Welcome to Sun Point Appliances (AKBARALLYS)</p>
                </div>
                
                <div class="email-body">
                    <div class="thank-you-box">
                        <div class="thank-you-icon">✅</div>
                        <p class="thank-you-text">Inquiry Received!</p>
                        <p class="thank-you-subtext">Dear ${name}, thank you for your inquiry. We're excited to assist you!</p>
                    </div>
